                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Armageddon Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Armageddon address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and armageddon: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zAGDN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Armageddon Core"), this);
    aboutAction->setStatusTip(tr("Show information about Armageddon Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Armageddon"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Armageddon addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Armageddon addresses"));
    ...
    openAction->setStatusTip(tr("Open a Armageddon: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Armageddon Core help message to get a list with possible Armageddon command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Armageddon Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Armageddon network", "", count));
}
...
{
    QString strTitle = tr("Armageddon Core"); // default title
