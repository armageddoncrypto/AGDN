...
/** Utility functions used by the Armageddon Qt UI.
 */
namespace GUIUtil
{
...
// Render Armageddon addresses in monospace font
...
// Parse "armageddon:" URI into recipient object, return true on successful parsing
