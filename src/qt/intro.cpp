...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Armageddon Core"),
     ...
     * override -datadir in the armageddon.conf file in the default data directory
     * (to be consistent with armageddond behavior)
     */
    if (dataDir != getDefaultDataDirectory())
