...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Armageddon server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Armageddon server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Armageddon features */
        {"armageddon", "masternode", &masternode, true, true, false},
        {"armageddon", "listmasternodes", &listmasternodes, true, true, false},
        {"armageddon", "getmasternodecount", &getmasternodecount, true, true, false},
        {"armageddon", "masternodeconnect", &masternodeconnect, true, true, false},
        {"armageddon", "masternodecurrent", &masternodecurrent, true, true, false},
        {"armageddon", "masternodedebug", &masternodedebug, true, true, false},
        {"armageddon", "startmasternode", &startmasternode, true, true, false},
        {"armageddon", "createmasternodekey", &createmasternodekey, true, true, false},
        {"armageddon", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"armageddon", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"armageddon", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"armageddon", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"armageddon", "getmasternodescores", &getmasternodescores, true, true, false},
        {"armageddon", "mnbudget", &mnbudget, true, true, false},
        {"armageddon", "preparebudget", &preparebudget, true, true, false},
        {"armageddon", "submitbudget", &submitbudget, true, true, false},
        {"armageddon", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"armageddon", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"armageddon", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"armageddon", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"armageddon", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"armageddon", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"armageddon", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"armageddon", "checkbudgets", &checkbudgets, true, true, false},
        {"armageddon", "mnsync", &mnsync, true, true, false},
        {"armageddon", "spork", &spork, true, true, false},
        {"armageddon", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"armageddon", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use armageddond, or the -server option to armageddon-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> armageddon-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:11811/\n";
}
