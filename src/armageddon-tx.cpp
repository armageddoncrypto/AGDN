...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Armageddon Core armageddon-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  armageddon-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded armageddon transaction") + "\n" +
                               "  armageddon-tx [options] -create [commands]   " + _("Create hex-encoded armageddon transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded armageddon transaction
