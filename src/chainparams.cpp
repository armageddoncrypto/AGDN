...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Armageddon: 1 day
        nTargetSpacing = 1 * 60;  // Armageddon: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
	...
	hashGenesisBlock = genesis.GetHash();
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("nodes-test.armageddon.pw", "nodes-test.armageddon.pw")); // Primary DNS Seeder
        vSeeds.push_back(CDNSSeedData("armageddon-test.nodes.gyservers.com", "armageddon-test.nodes.gyservers.com")); // Secondary DNS Seeder
        vSeeds.push_back(CDNSSeedData("armageddon-test.seeds.mn.zone", "armageddon-test.seeds.mn.zone")); // Third party DNS Seeder
        vSeeds.push_back(CDNSSeedData("armageddon-test.mnseeds.com", "armageddon-test.mnseeds.com")); // Third party DNS Seeder


        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet armageddon addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet armageddon script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet armageddon BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet armageddon BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet armageddon BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Armageddon: 1 day
        nTargetSpacing = 1 * 60;        // Armageddon: 1 minutes
