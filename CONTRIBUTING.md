Contributing to Armageddon Core
============================

The Armageddon Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Armageddon Core project, and is not to be
confused with overall Armageddon Network Protocol consensus changes.

Whether a pull request is merged into Armageddon Core rests with the project merge
...
Patches that change Armageddon consensus rules are considerably more involved than
...
Where a patch set proposes to change the Armageddon consensus, it must have been
...
The project leader is the release manager for each Armageddon Core release.
