...
In order to support loading of multiple wallets in armageddon-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is armageddon.cpp.
...
Changes to armageddon.cpp
----------------------
armageddon.cpp is the entry point into armageddon-qt, and as such, will require some minor modifications to provide hooks for
